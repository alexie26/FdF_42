...
/*   Updated: 2025/04/12 20:39:03 by roalexan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../fdf.h"

static	void transform_point(t_3d pt, t_fdf *fdf, double *x, double *y, double *z)
{
	*x = pt.x * fdf->zoom;
	*y = pt.y * fdf->zoom;
	*z = pt.z * fdf->z_scale;
...
static t_point apply_isometric_projection(double x, double y, double z, t_fdf *fdf)
{
    t_point projected;
